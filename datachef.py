...
tf.app.flags.DEFINE_integer('image_side_length', 224,
                            'Length of the side of the square target images.')
...
class ImageCoder(object):
  ...
  def __init__(self):
    ...
    #self._crop_jpeg = tf.image.resize_image_with_crop_or_pad(self._resize_jpeg, FLAGS.image_side_length, FLAGS.image_side_length)
  ...
  def resize_and_crop(self, image_data, height, width, real_height, real_width):
    return self._sess.run(self._encode_resized_jpeg, feed_dict={self._decode_jpeg_data: image_data,
                                                                self._height: height,
                                                                self._width: width,
...
def _process_image(filename, coder):
  ...
  assert final_height == final_height
